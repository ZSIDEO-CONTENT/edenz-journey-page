...
SECRET_KEY = os.getenv('SECRET_KEY', 'django-insecure-edenz_consultants_secret_key_please_change_in_production')
...
# JWT Settings
SIMPLE_JWT = {
    'ACCESS_TOKEN_LIFETIME': timedelta(days=30),  # Match your current settings
